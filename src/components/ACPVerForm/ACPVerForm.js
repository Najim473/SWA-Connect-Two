      ...
      <div className={avfStyle.container}>
          ...
          <div class="row px-5">
            <div class="col-12 col-md-6 col-lg-4">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="SSID" />
              </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4">
              <div class="mb-3">
          ...
          <div class="row px-5">
            <div class="col-12 col-md-6  ">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Compatibility" />
              </div>
            </div>
            <div class="col-12 col-md-6  ">
              <div class="mb-3">
        ...
        <div class=" m-3 " >
          <div class="d-flex mt-3">
            ...
            {plusBtn && <i onClick={handleClick} style={{ cursor: 'pointer' }} class="bi bi-plus-square fs-3 ms-3 "></i>}
            {!plusBtn && <i onClick={handleClick} style={{ cursor: 'pointer' }} class="bi bi-dash-square fs-3 ms-3 "></i>}
          </div>
        </div>
        {/* SIM CARD DATA END  */}
        {
            ...
            <div class="row px-5">
              ...
              <div class="col-12 col-md-6 col-lg-3">
                <div class="mb-3">
                  ...
                  <select onChange={govidChnage} class="form-select" aria-label="Select Tabs" ref={disabledRef} disabled={active}>
            ...
            {visible &&
              <div>
                <div class="row px-5">
                  <div class="col-12 col-md-6 col-lg-6">
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label">Other ID Name</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1" placeholder=" ID Name" />
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-lg-6">
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label">Other ID</label>
              ...
              <div>
                <div class="row px-5">
                  <div class="col-12 col-md-12 col-lg-4">
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label">Driving Licence</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Driving Licence" />
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-lg-4">
                    <div class="mb-3">
            ...
            {visible4 &&
              <div>
                <div class="row px-5">
                  <div class="col-12 col-md-12 col-lg-4">
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label">Military ID</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Military ID" />
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-lg-4">
                    <div class="mb-3">
                ...
                <div class="row px-5">
                  <div class="col-12 col-md-12 col-lg-4">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Passport" />
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-lg-4">
                    <div class="mb-3">
            ...
            {visible6 &&
              <div>
                <div class="row px-5">
                  <div class="col-12 col-md-12 col-lg-4">
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label">Taxpayer ID</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Taxpayer ID" />
                    </div>
                  </div>
                  <div class="col-12 col-md-6 col-lg-4">
                    <div class="mb-3">
            ...
            <div class="row px-5">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="mb-3">
                  ...
                  <select onChange={bqpChange} class="form-select" aria-label="Default select example" ref={bqpRef}>
                    <option selected value="Select">Select</option>
                    <option value="Yes">Yes</option>
                    <option value="No">No</option>
                  </select>
                ...
                <div class="row px-5">
                  ...
                  <div class="col-12 col-md-6 col-lg-3">
                    <div class="mb-3">
                      ...
                      <select onChange={bqpselectChange} class="form-select" aria-label="Default select example" ref={bqpselectRef}>
                        <option selected value="No">No</option>
                        <option value="Yes">Yes</option>
                      </select>
                    </div>
                  ...
                  <div class="col-12 col-md-6 col-lg-3">
                    <div class="mb-3">
                      <label for="exampleFormControlInput1" class="form-label"> BQP Alternative ID Type</label>
                      <select onChange={bqpalterChange} class="form-select" aria-label="Select Tabs" ref={bqpalterRef} disabled>
